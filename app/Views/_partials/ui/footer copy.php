            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 col-xl-7">
                    <div class="newsletter-text mb-100">
                        <h2>Selamat Datang Di Toko <span>Nikasa</span></h2>
                        <p>Toko kami menjual segala jenis banten dengan cara order pesan dahulu :)</p>
                    </div>
                </div>
                <!-- Newsletter Form -->
                                ...
                                <div class="collapse navbar-collapse" id="footerNavContent">
                                    <ul class="navbar-nav ml-auto">
                                        <li class="nav-item active">
                                            <a class="nav-link" href="<?php echo base_url('ui-amado'); ?>/index.html">Home</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url('ui-amado'); ?>/shop.html">Shop</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url('ui-amado'); ?>/cart.html">Cart</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url('ui-amado'); ?>/checkout.html">Checkout</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
